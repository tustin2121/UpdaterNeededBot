...
/*0xC0*/0x0000, 0x0000, 0x0000, 0x0000, 0x0153, 0x0154, 0x0155, 0x0156, 0x0157, 0x0121, 0x0122, 0x0123, 0x0124, 0x0125, 0x0126, 0x0127,
...
RULES.push(new Rule(`When transitioning, supress Full Heal messages.`)
	.when(ledger=>ledger.has('BurningDownContext', 'BurningUpContext'))
